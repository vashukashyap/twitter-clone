const CreateAccountDialogBox = ({ visible, onClose }) => {
  ...
  return (
    <>
      <div className="flex h-full w-full items-center justify-center absolute top-0 bg-[#242D34] bg-opacity-60">
...
export default CreateAccountDialogBox;
